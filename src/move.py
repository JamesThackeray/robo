...
coord= (current.position.x,current.position.y)

print('Initial X coordinate: ', coord[0])

print('Initial Y coordinate: ', coord[1])

current_orientation_quaternion = (current.orientation.x, current.orientation.y, current.orientation.z, current.orientation.w)
...
print('Initial starting angle Theta wrt +X axis: ', angle)   
...
print('(X, Y, Theta):', coord[0], coord[1], angle)
